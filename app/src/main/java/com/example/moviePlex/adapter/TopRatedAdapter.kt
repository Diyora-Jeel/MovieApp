...
class TopRatedAdapter(private val context: Context, private val list : ArrayList<Result>,private val mainOnclick: MainOnclick) : RecyclerView.Adapter<TopRatedAdapter.NowPlayingViewHolder>()
{
