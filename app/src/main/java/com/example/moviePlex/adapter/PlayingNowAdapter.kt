...
class PlayingNowAdapter(private val context: Context, private val list : ArrayList<Result>,private val mainOnclick: MainOnclick) : RecyclerView.Adapter<PlayingNowAdapter.NowPlayingViewHolder>()
{
